...
<body>
    <div class="container-fluid"; id="top_bar">
        ...
        <div id="Login_form">
            <form action="./logar.php" method="POST" >
                <input id="Login" type="text" placeholder="Digite seu login.." name="login">
                <input id="Senha" type="password" placeholder="Digite sua senha.." name="senha">
                <input type="submit" class="btn btn-success btn-sm" value="Logar">
            </form>
        </div>
    </div>
    ...
    <?php
        if(isset($_GET['msg'])){
            ?>
            <h5>Verifique seu login e senha</h5>
            <?php
        }
    ?>
